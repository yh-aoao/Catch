...
roll_hand_close_distance = 0.25
roll_hand_ready_target = np.array([0.35, 0.20, 0.20])
roll_hand_close_target = np.array([1.10, 0.85, 0.70])
roll_hand_thumb_target = 0.4
roll_hand_flex_max = 1.4
roll_w_hand_pose = 1.0
roll_w_hand_closure = 4.0
...
basket_joint_smooth_weight = 0.01  # action-change cost for controllable joints
